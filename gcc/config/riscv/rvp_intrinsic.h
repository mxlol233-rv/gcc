...
CREATE_RVP_INTRINSIC(uintXLEN_t, sra8, uintXLEN_t,  uint32_t)
CREATE_RVP_INTRINSIC_ALIAS(uintXLEN_t, srai8, sra8, uintXLEN_t, const uint32_t)
CREATE_RVP_INTRINSIC(uintXLEN_t, sra8_u, uintXLEN_t,  uint32_t)
CREATE_RVP_INTRINSIC_ALIAS(uintXLEN_t, srai8_u, sra8_u, uintXLEN_t, const uint32_t)
CREATE_RVP_INTRINSIC(uintXLEN_t, sra16, uintXLEN_t,  uint32_t)
CREATE_RVP_INTRINSIC_ALIAS(uintXLEN_t, srai16, sra16, uintXLEN_t, const uint32_t)
CREATE_RVP_INTRINSIC(uintXLEN_t, sra16_u, uintXLEN_t,  uint32_t)
CREATE_RVP_INTRINSIC_ALIAS(uintXLEN_t, srai16_u, sra16_u, uintXLEN_t, const uint32_t)
...
CREATE_RVP_INTRINSIC_VECTOR(int32xN_t, kmmawb_u, int32xN_t, int32xN_t,
                            int16xN_t)
CREATE_RVP_INTRINSIC_VECTOR(int32xN_t, kmmawb2, int32xN_t, int32xN_t, int16xN_t)
CREATE_RVP_INTRINSIC_VECTOR(int32xN_t, kmmawb2_u, int32xN_t, int32xN_t,
                            int16xN_t)
CREATE_RVP_INTRINSIC_VECTOR(int32xN_t, kmmawt, int32xN_t, int32xN_t, int16xN_t)
CREATE_RVP_INTRINSIC_VECTOR(int32xN_t, kmmawt_u, int32xN_t, int32xN_t,
                            int16xN_t)
CREATE_RVP_INTRINSIC_VECTOR(int32xN_t, kmmawt2, int32xN_t, int32xN_t, int16xN_t)
CREATE_RVP_INTRINSIC_VECTOR(int32xN_t, kmmawt2_u, int32xN_t, int32xN_t,
                            int16xN_t)
...
CREATE_RVP_INTRINSIC_VECTOR(uintXLEN_t, pbsada, uintXLEN_t, uint8xN_t,
                            uint8xN_t)
...
CREATE_RVP_INTRINSIC_VECTOR(int8xN_t, sra8, int8xN_t,  uint32_t)
CREATE_RVP_INTRINSIC_VECTOR_ALIAS(int8xN_t, srai8, sra8, int8xN_t, const uint32_t)
CREATE_RVP_INTRINSIC_VECTOR(int8xN_t, sra8_u, int8xN_t,  uint32_t)
CREATE_RVP_INTRINSIC_VECTOR_ALIAS(int8xN_t, srai8_u, sra8_u, int8xN_t, const uint32_t)
CREATE_RVP_INTRINSIC_VECTOR(int16xN_t, sra16, int16xN_t,  uint32_t)
CREATE_RVP_INTRINSIC_VECTOR_ALIAS(int16xN_t, srai16, sra16, int16xN_t, const uint32_t)
CREATE_RVP_INTRINSIC_VECTOR(int16xN_t, sra16_u, int16xN_t,  uint32_t)
CREATE_RVP_INTRINSIC_VECTOR_ALIAS(int16xN_t, srai16_u, sra16_u, int16xN_t, const uint32_t)
...
CREATE_RVP_INTRINSIC_ALIAS(intXLEN_t, wexti, wext, uint64_t, const uint32_t)
#endif
...
CREATE_RVP_INTRINSIC_ALIAS(int64_t, v_kmada32, v_kmar64, int64_t, int32x2_t,
                           int32x2_t)
#endif
#endif // END OF ZPSF
...
__extension__ extern __inline
    __attribute__((__always_inline__, __gnu_inline__, __artificial__)) uint8xN_t
    __rv_v_rev8h(uint8xN_t a) {
